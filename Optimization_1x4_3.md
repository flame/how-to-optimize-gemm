Copy the contents of file [`MMult2.c`](../blob/master/src/MMult2.c) into a file named [`MMult_1x4_3.c`](../blob/master/src/MMult_1x4_3.c) and change the contents:
...
![](../raw/master/figures/compare_MMult2_MMult-1x4-3.png)
